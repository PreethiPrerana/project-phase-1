...
import com.recipe.project.DTO.RecipeDetails.RecipeDetailsDTO;
...
public class MealController {
    ...
    public ResponseEntity<RecipeDetailsDTO> getRecipeDetails(@PathVariable String recipeId) {
        String apiKey = "668459505d964573bdefa9396899795c";
        String url = "https://api.spoonacular.com/recipes/" + recipeId + "/information?apiKey=" + apiKey;

        RestTemplate restTemplate = new RestTemplate();
        ResponseEntity<RecipeDetailsDTO> response = restTemplate.getForEntity(url, RecipeDetailsDTO.class);
